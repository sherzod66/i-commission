...
import styles from './defaultP.module.scss'
import cn from 'clsx'
...
import { cleanNumber, formatNumberForDisplay, formatPrice } from '@/utils/formatPrice'
type TDefaultProductProps = {
	setType: Dispatch<SetStateAction<EnumProductTypeName | null>>
}

const DefaultProduct: FC<TDefaultProductProps> = ({ setType }) => {
	const {
		errors,
		handleSubmit,
		onSubmit,
