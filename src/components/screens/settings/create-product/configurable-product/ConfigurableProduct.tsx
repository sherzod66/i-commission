...
import styles from '../default-product/defaultP.module.scss'
import cn from 'clsx'
import ProductImagePicker from '../product-image/ProductImagePicker'
import { Controller } from 'react-hook-form'
import { Select } from 'antd'
import Loader from '@/components/ui/loader/Loader'
import { EnumProductTypeName } from '@/types/product.type'
import { configurationSelect, useConfigurableProduct } from './useConfigurableProduct'
...
type TDefaultProductProps = {
	setType: Dispatch<SetStateAction<EnumProductTypeName | null>>
}

const ConfigurableProduct: FC<TDefaultProductProps> = ({ setType }) => {
	const {
		errors,
		handleSubmit,
		onSubmit,
		...
		<>
			<div className={styles.first__column}>
				...
				<form onSubmit={handleSubmit(onSubmit)}>
										...
										<div className={styles.configuration__head}>
											...
											<div className={styles.head__type}>
												...
												<Select
													...
													onChange={(value, option) => selectOnChange(value, 'middle', middleIndex)}
												/>
											</div>
										</div>
									</div>
					...
					<button onClick={createMiddleEntity} type='button' className={styles.add__configuration}>
					...
					<div className={styles.buttons__actions}>
						<button onClick={() => setType(null)} type='button' className={styles.cancel}>
							Отменить
						</button>
						<div className={styles.create__button}>
							{uploadLoading || loading ? (
								...
								<button disabled={uploadLoading || loading} type='submit' className={styles.create}>
									Опубликовать товар
								</button>
							)}
						</div>
			...
			<div className={styles.second__column}>
				<div className={styles.product__image}>
					<ProductImagePicker control={control} />
				</div>
